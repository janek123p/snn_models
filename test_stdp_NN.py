...
net = Network(sim_params={"t_sim": 10000.})

input_neuron = lif_neuron_matrix(net, {"I_e": 500.})
...
output_neuron = lif_neuron_matrix(net, {"I_e": 120.})

syn = STDP_NN_SymmSnyapse(net, input_neuron, output_neuron, init_weight = 700., delay = 1.5, params={"w_max":1400})
syn = STDP_NN_SymmSnyapse(net, input_neuron2, output_neuron, init_weight = 300., delay = 2.5, params={"w_max":1400})
syn = STDP_NN_SymmSnyapse(net, input_neuron3, output_neuron, init_weight = 400., delay = 2, params={"w_max":1400})
syn = STDP_NN_SymmSnyapse(net, input_neuron4, output_neuron, init_weight = 800., delay = 0.5, params={"w_max":1400})
